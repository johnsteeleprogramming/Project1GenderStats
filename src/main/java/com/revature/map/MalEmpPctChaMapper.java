...
public class MalEmpPctChaMapper extends Mapper<LongWritable, Text, Text, Text>{
	...
	private static String[] descriptionCodes = {"SL.AGR.EMPL.MA.ZS", 
		"SL.IND.EMPL.MA.ZS", "SL.SRV.EMPL.MA.ZS", "SL.EMP.TOTL.SP.MA.ZS",
		"SL.EMP.TOTL.SP.MA.NE.ZS", "SL.EMP.1524.SP.MA.ZS", "SL.EMP.1524.SP.MA.NE.ZS",
		"SL.ISV.IFRM.MA.ZS"};
