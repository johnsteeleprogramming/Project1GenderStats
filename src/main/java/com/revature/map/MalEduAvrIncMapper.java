...
public class MalEduAvrIncMapper extends Mapper<LongWritable, Text, Text, Text> {
	
	private static String[] descriptionCodes = {"SE.TER.CUAT.BA.MA.ZS", 
		"SE.SEC.CUAT.LO.MA.ZS", "SE.SEC.CUAT.PO.MA.ZS", "SE.PRM.CUAT.MA.ZS",
		"SE.TER.CUAT.ST.MA.ZS", "SE.SEC.CUAT.UP.MA.ZS", "SE.TER.CUAT.MS.MA.ZS",
		"SE.TER.HIAT.BA.MA.ZS", "SE.TER.HIAT.DO.MA.ZS", "SE.SEC.HIAT.LO.MA.ZS",
		"SE.TER.HIAT.MS.MA.ZS", "SE.SEC.HIAT.PO.MA.ZS", "SE.PRM.HIAT.MA.ZS",
		"SE.TER.HIAT.ST.MA.ZS", "SE.SEC.HIAT.UP.MA.ZS", "SE.TER.CUAT.DO.MA.ZS"};
